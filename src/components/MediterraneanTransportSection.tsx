      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="mt-12 max-w-3xl mx-auto">
            ...
            <div className="bg-green-50 p-5 rounded-lg border border-green-100">
              <h4 className="font-semibold text-green-800 mb-3 flex items-center">
                <div className="bg-green-200 p-2 rounded-full mr-3">
                  <Train size={18} className="text-green-700" />
                </div>
            ...
            <div className="bg-yellow-50 p-5 rounded-lg border border-yellow-100">
              <h4 className="font-semibold text-yellow-800 mb-3 flex items-center">
                <div className="bg-yellow-200 p-2 rounded-full mr-3">
                  <Car size={18} className="text-yellow-700" />
                </div>
                Location de voiture
              </h4>
              <ul className="text-gray-700 space-y-2 text-sm">
          ...
          <div className="mt-6 p-5 bg-blue-50 rounded-lg border border-blue-100">
            <h4 className="font-semibold text-blue-800 mb-3">Applications de transport utiles</h4>
            <ul className="text-gray-700 space-y-2 text-sm">
              <li className="flex items-start">
